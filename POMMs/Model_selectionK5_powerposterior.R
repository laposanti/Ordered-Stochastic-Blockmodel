...
for(dataset in seq(1,25,5)){
  ...
  for(diag0.5 in c(T,F)){
    if(diag0.5==T){
      ...
      folder_url <- "https://drive.google.com/drive/u/1/folders/1lXiucMEB_W9j3mj9LhWOuY2NVyWISLu_"
    }else{
      folder_url <- "https://drive.google.com/drive/u/1/folders/1VDEdynvDC5SCeFrVgRZYL4Qvgbs9ljIT"
