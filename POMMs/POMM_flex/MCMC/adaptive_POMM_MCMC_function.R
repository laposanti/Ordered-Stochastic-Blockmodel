...
adaptive_MCMC_POMM <- function(Yij_matrix, Nij_matrix,init , z_true, overlap, alpha,p_true, N,K, N_iter, targ_rate, beta_max, gamma_vec, diag0.5, seed){
  ...
  C_current =  l_like_p_ij_normal_overlap(K = K, P_matrix = p_current,overlap =overlap_current, truncations = truncations_current,diag0.5 = T) + dlnorm_mu_sigma(alpha_current) +dlnorm_mu_sigma(overlap_current)
