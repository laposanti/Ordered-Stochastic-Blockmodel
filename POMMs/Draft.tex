...
\begin{tabular}{cccccccccc}
\toprule
\multirow{2}{*}{Method} & \multicolumn{3}{c}{ESS} & \multicolumn{3}{c}{Autocorrelation lag=30} & \multicolumn{3}{c}{acceptance rate} & \multicolumn{3}{c}{
Gelman Rubin stat}$} && \multicolumn{3}{c}{vi dist}  \\
\cmidrule(lr){2-4} \cmidrule(lr){5-7} \cmidrule(lr){8-10}
& $(a)$ & $(b)$ & $(c)$ & $(a)$ & $(b)$ & $(c)$ & $(a)$ & $(b)$ & $(c)$ \\
\midrule
POMM model  &0&  0 & 0.33 & 0 & 0.4  & 0.44 & $\underset{17.01}{-6418.29}$ & $\underset{18.74}{-6196.77}$ & $\underset{18.58}{6320.08}$  \\
...
\subsubsection{Montecarlo algorithm}
some considerations on my prior.
