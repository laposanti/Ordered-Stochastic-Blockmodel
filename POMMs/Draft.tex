...
\begin{figure}[htbp]
    ...
    \subfigure[K=3, Simple Model]{%
        \includegraphics[width=.33\textwidth,natwidth=518,natheight=526]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/adjacencyk3m4000simple.png}%
        \label{fig:M4000}%
    }\hfill
    \subfigure[K=5, Simple Model]{%
        \includegraphics[width=.33\textwidth,natwidth=518,natheight=526]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/adjacencyk5m4000simple.png}%
        \label{fig:M7000}%
    }\hfill
    \subfigure[K=9, Simple Model]{%
        \includegraphics[width=.33\textwidth,natwidth=518,natheight=526]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/adjacencyk9m4000simple.png}%
        \label{fig:M10000}%
    }
...
\begin{figure}[htbp]
    \centering
    \subfigure[K=3, Simple Model]{%
        \includegraphics[width=.3333\textwidth,natwidth=518,natheight=560]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/similarityk3m4000simplesimple.png}%
        \label{fig:M4000}%
    }\hfill
    \subfigure[K=5, Simple Model]{%
        \includegraphics[width=.3333\textwidth,natwidth=518,natheight=560]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/similarityk5m4000simplesimple.png}%
        \label{fig:M7000}%
    }\hfill
    \subfigure[K=9, Simple Model]{%
        \includegraphics[width=.3333\textwidth,natwidth=518,natheight=560]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/similarityk9m4000simplesimple.png}%
        \label{fig:M10000}%
    }\\[2ex]\subfigure[K=3, POMM Model]{%
        \includegraphics[width=.3333\textwidth,natwidth=518,natheight=560]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/similarityk3m4000simplePOMM.png}%
        \label{fig:M4000}%
    }\hfill
    \subfigure[K=5, POMM Model]{%
        \includegraphics[width=.3333\textwidth,natwidth=518,natheight=560]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/similarityk5m4000simplePOMM.png}%
        \label{fig:M7000}%
    }\hfill
    \subfigure[K=9, POMM Model]{%
        \includegraphics[width=.3333\textwidth,natwidth=518,natheight=560]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/similarityk9m4000simplePOMM.png}%
        \label{fig:M10000}%
    }
...
\begin{figure}[htbp]
    ...
    \subfigure[K=3, POMM Model]{%
        \includegraphics[width=.33\textwidth,natwidth=518,natheight=526]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/adjacencyk3m4000POMM.png}%
        \label{fig:M4000}%
    }\hfill
    \subfigure[K=5, POMM Model]{%
        \includegraphics[width=.33\textwidth,natwidth=518,natheight=526]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/adjacencyk5m4000POMM.png}%
        \label{fig:M7000}%
    }\hfill
    \subfigure[K=9, POMM Model]{%
        \includegraphics[width=.33\textwidth,natwidth=518,natheight=526]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/adjacencyk9m4000POMM.png}%
        \label{fig:M10000}%
    }
...
\begin{figure}[htbp]
    ...
    \subfigure[K=3, Simple Model Estimates]{%
        \includegraphics[width=.3333\textwidth,natwidth=518,natheight=560]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/similarityk3m4000POMMsimple.png}%
        \label{fig:M4000}%
    }\hfill
    \subfigure[K=5, Simple Model Estimates]{%
        \includegraphics[width=.3333\textwidth,natwidth=518,natheight=560]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/similarityk5m4000POMMsimple.png}%
        \label{fig:M7000}%
    }\hfill
    \subfigure[K=9, Simple Model Estimates]{%
        \includegraphics[width=.3333\textwidth,natwidth=518,natheight=560]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/similarityk9m4000POMMsimple.png}%
        \label{fig:M10000}%
    }\\[2ex]\subfigure[K=3, POMM Model Estimates]{%
        \includegraphics[width=.3333\textwidth,natwidth=518,natheight=560]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/similarityk3m4000POMMPOMM.png}%
        \label{fig:M4000}%
    }\hfill
    \subfigure[K=5, POMM Model Estimates]{%
        \includegraphics[width=.3333\textwidth,natwidth=518,natheight=560]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/similarityk5m4000POMMPOMM.png}%
        \label{fig:M7000}%
    }\hfill
    \subfigure[K=9, POMM Model Estimates]{%
        \includegraphics[width=.3333\textwidth,natwidth=518,natheight=560]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/similarityk9m4000POMMPOMM.png}%
        \label{fig:M10000}%
    }
    \caption{Co-Clustering Matrices obtained via the Simple Model(above) and the POMM model (below).}
    \label{fig:all_images}
...
\begin{figure}[htbp]
    \centering
    \subfigure[K=4, Chain1]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/posteriorpredictive_firstchain.png}%
        \label{fig:posteriorpredictive1}%
    }\hfill
    \subfigure[K=4, Chain2]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/posteriorpredictive_secondchain.png}%
        \label{fig:posteriorpredictive2}%
    }\\[2ex]\subfigure[K=4, Chain3]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/posteriorpredictive_thirdchain.png}%
        \label{fig:posteriorpredictive3}%
    }\hfill
    \subfigure[K=4, Chain4]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/posteriorpredictive_fourthchain.png}%
        \label{fig:posteriorpredictive4}%
    }
    \caption{Posterior predictive check: simulating from the estimated parameters}
...
\begin{figure}[htbp]
    \centering
    \subfigure[K=4, Chain1-4, $P_{1,2}$]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/Density_plots/density_plot_4_chains_p_1_2.png}%
        \label{fig:posteriorpredictive1}%
    }\hfill
    \subfigure[K=4, Chain1-4, $P_{1,3}$]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/Density_plots/density_plot_4_chains_p_1_3.png}%
        \label{fig:posteriorpredictive2}%
    }\\[2ex]\subfigure[K=4, Chain1-4, $P_{1,4}$]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/Density_plots/density_plot_4_chains_p_1_4.png}%
        \label{fig:posteriorpredictive3}%
    }\hfill
    \subfigure[K=4, Chain1-4, $P_{2,3}$]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/Density_plots/density_plot_4_chains_p_2_3.png}%
        \label{fig:posteriorpredictive4}%
    }\\[2ex]\subfigure[K=4, Chain1-4, $P_{2,4}$]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/Density_plots/density_plot_4_chains_p_2_4.png}%
        \label{fig:posteriorpredictive3}%
    }\hfill
    \subfigure[K=4, Chain1-4, $P_{3,4}$]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/Density_plots/density_plot_4_chains_p_3_4.png}%
        \label{fig:posteriorpredictive4}%
    }

    \caption{Density plot for each P entry: in red the true P value. Different lines correspond to different chains}
    \label{fig:predictive_checks}
\end{figure}


\subsubsection{Traceplot}

\begin{figure}[htbp]
    \centering
    \subfigure[K=4, Chain1]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/traceplots/traceplot_likelihood_chain1.png}%
        \label{fig:posteriorpredictive1}%
    }\hfill
    \subfigure[K=4, Chain2]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/traceplots/traceplot_likelihood_chain2.png}%
        \label{fig:posteriorpredictive2}%
    }\\[2ex]\subfigure[K=4, Chain3]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/traceplots/traceplot_likelihood_chain3.png}%
        \label{fig:posteriorpredictive3}%
    }\hfill
    \subfigure[K=4, Chain4]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/traceplots/traceplot_likelihood_chain4.png}%
        \label{fig:posteriorpredictive4}%
    }
    \caption{Traceplot of the likelihood at each iteration for the 4 chains, namely $\sum_{ij} \log \left( p \left( y_ij |\hat{z}^{(t)}, \hat{P}^{(t)} \right) \right) $}
    \label{fig:predictive_checks}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \subfigure[K=4, Chain1]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/autocorrplot/autocorrplot_chain1.png}%
        \label{fig:posteriorpredictive1}%
    }\hfill
    \subfigure[K=4, Chain2]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/autocorrplot/autocorrplot_chain2.png}%
        \label{fig:posteriorpredictive2}%
    }\\[2ex]\subfigure[K=4, Chain3]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/autocorrplot/autocorrplot_chain3.png}%
        \label{fig:posteriorpredictive3}%
    }\hfill
    \subfigure[K=4, Chain4]{%
        \includegraphics[width=.5\textwidth,natwidth=800,natheight=524]{/Users/lapo_santi/Desktop/Nial/POMM_pairwise/POMMs/power_law_prior/Modular_code/results/diagnostic_checks/autocorrplot/autocorrplot_chain4.png}%
        \label{fig:posteriorpredictive4}%
    }
    \caption{Autocorrplot of the likelihood at each iteration for the 4 chains, namely}
    \label{fig:predictive_checks}
\end{figure}
