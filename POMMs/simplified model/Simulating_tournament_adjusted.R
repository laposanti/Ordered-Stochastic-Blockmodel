...
simulating_tournament_test<- function(N,c_concentration,b_max, min_clust,max_clust,M, n_ij_max){
  ...
  p = simulating_POMM_stick_breaking(K,c=c_concentration, beta_max = b_max)
