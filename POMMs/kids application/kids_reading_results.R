...
data_wd<-  '/Users/lapo_santi/Desktop/Nial/MCMC_results/kids_application/'

#where the data will be saved
tap <- '/Users/lapo_santi/Desktop/Nial/MCMC_results/kids_application/processed_results/'
plots_dir<- '/Users/lapo_santi/Desktop/Nial/MCMC_results/kids_application/processed_results/'
...
while(controller==0){
  ...
  true_model <- 'kids_data_Est_model_'
