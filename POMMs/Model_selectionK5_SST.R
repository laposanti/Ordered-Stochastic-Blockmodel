...
for(dataset in 1:length(filenames)){
  ...
  saving_directory = './Results/MCMC_output/model_choice/WAIC_method/diag_free/K5_true/'
  ...
  if('SST' %in% choose_model_to_estimate){
    ...
    my_filename = paste0(saving_directory,'Data_from',
                         ...
                         'sparsity',data_to_be_estimated$sparsity,
                         ,"seed",  data_to_be_estimated$seed, '.rds')
